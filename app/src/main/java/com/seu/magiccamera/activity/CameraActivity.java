...
public class CameraActivity extends Activity{
            ...
            switch (v.getId()){
                ...
                case R.id.btn_camera_beauty:
                    new AlertDialog.Builder(CameraActivity.this)
                            .setSingleChoiceItems(new String[] { "close", "BeautyLevel 1", "BeautyLevel 2", "BeautyLevel 3", "BeautyLevel 4", "BeautyLevel 5"}, MagicParams.beautyLevel,
    ...
    private void takePhoto(){
        magicEngine.savePicture(getOutputMediaFile(),null,ReturnAngle(CameraActivity.this));
